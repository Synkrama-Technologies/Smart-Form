...
<body>
    ...
    <div class="container">
        ...
        foreach ($form_data as $row) {
            ...
            $form_redirect_path = $row->form_redirect_path;
        ...
        <div>
            <h2 class="text-center text-uppercase fw-bold">Update Form : <?php echo $form_name; ?>
        </div>
        <br>
        ...
        <form action="update_form" method="POST">
            ...
            <br>
            <div>
                <!-- <label for="textarea_tags" class="form-label pt-1">Form Template</label> -->
                <br>
                <div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="textarea_tags" id="new_textarea" class="form-control" style="min-height:320px;" required><?php echo $form_data; ?><?php echo "\n\n"; ?></textarea>

                </div>
                <br>
                <div class="form-group">
                    <label class="fw-bold">HTML Code</label>
                    <textarea name="textarea_html_tags" id="textarea_html_code" class="form-control" style="min-height:320px;" required><?php echo $form_html; ?><?php echo "\n\n"; ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <input type="url" name="form_lead_page" class="form-control" placeholder="Enter Lead Page" value="<?php echo $form_lead_page; ?>">
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <input type="url" name="form_landing_page" class="form-control" placeholder="Enter Landing Page" value="<?php echo $form_landing_page; ?>">
                </div>
            </div>
            <br>
            <div class="text-center">
                <a href="edit_form" class="btn btn-orange m-4 btn1">Back</a>
                <button type="submit" name="update_data" class="btn btn-purple m-4 btn1">Update</button>
            </div>
        </form>
